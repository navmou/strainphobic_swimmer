/***
    ...
    Jun. 16, 2022
    Added more actions to swim froward with vs and also rotate while stopping
...
int main(){
  ...
  double init_y , last_y , delta_y , delta_x, reward_sum , trSS_sum , init_x , last_x;
  ...
  for(int i=1 ; i <= n_fields ; ++i){
    ...
    UXS.push_back(load_field(path, "/flowData/uxs", nx , ny)); //uys is given as UXS because of transposing to preserve the structure
    UYS.push_back(load_field(path, "/flowData/uys", nx , ny)); //uxs is given as UYS because of transposing to preserve the structure
