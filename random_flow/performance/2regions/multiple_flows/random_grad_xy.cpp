...
int GET_STATE(double gradx , double grady);
...
beta 0.0 : {1,0,2,3,0,2,1,1,1,1,0,2,1,3,2,2,3,1,1,0,0,1,3,2,4};
beta 0.1 : {2,2,1,3,1,3,3,0,1,1,2,2,4,1,2,3,1,3,0,3,0,1,3,2,1};
beta 0.2 : {2,3,4,3,0,4,4,4,3,0,1,1,2,1,0,1,2,2,0,0,1,3,2,0,0};
beta 0.3 : {1,3,0,2,0,1,0,1,3,2,3,4,1,1,3,3,0,2,0,2,0,4,3,1,0};
beta 0.4 : {2,3,0,2,0,0,4,3,0,3,3,1,1,0,0,3,2,3,0,3,0,1,0,0,2};
beta 0.5 : {0,0,1,1,1,3,3,3,2,1,2,2,3,0,3,3,0,3,0,1,2,3,3,2,2};
beta 0.6 : {3,0,3,3,0,0,2,3,2,0,0,3,4,1,1,0,3,0,2,1,2,1,2,1,3};
beta 0.7 : {2,2,2,2,3,2,1,2,0,1,0,2,4,2,1,2,0,2,2,3,3,0,0,0,2};
beta 0.8 : {2,0,0,2,3,3,4,0,2,1,0,4,0,1,1,2,3,2,1,3,3,2,0,0,1};
beta 0.9 : {3,0,0,0,0,1,0,0,3,3,1,1,4,3,2,1,1,1,3,2,3,1,3,0,0};
beta 1.0 : {3,2,2,4,4,0,1,3,1,1,3,4,3,0,3,3,2,0,4,2,1,0,1,0,1};
*/
...
//opening HDF5 file
H5File file("random_onlygrad.h5", H5F_ACC_TRUNC);
	  ...
	  while(state_new == state)
	    {
	      ...
	      grady = 2*a11*d2ux12 + 2*a22*d2uy22 + (a12 + a21)*(d2ux22 + d2uy12);
	      trSS = a11*a11 + 0.5*(a12+a21)*(a12+a21) + a22*a22;
	      state_new = GET_STATE(grady , grady);
...
//STATE EVALUATION
int GET_STATE(double grad_sx , double grad_sy){
  int state;
