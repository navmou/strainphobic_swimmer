...
plt.figure(figsize=(15,13))
plt.plot(np.arange(1,16) , ys[0] , '^--' , label = r'$(\partial_x \rm{Tr}S^2) , Tr(S^2)$' , MarkerSize = 15 , color = 'green')
plt.plot(np.arange(1,16) , ys[1] , 'o--' , label = r'$(\partial_y \rm{Tr}S^2)  , Tr(S^2)$' , MarkerSize = 15, color = 'red')
plt.plot(np.arange(1,16) , ys[2] , 'h--' , label = r'$(\nabla \rm{Tr}S^2) , Tr(S^2)$'  , MarkerSize = 15, color = 'purple')
plt.plot(np.arange(1,16) , ys[3] , '*--' , label = r'$(\nabla \rm{Tr}S^2)$'   , MarkerSize = 15, color = 'blue')
plt.xticks(np.arange(1,16) , strategies , rotation = 90)
...
plt.figure(figsize=(15,13))
plt.plot(np.arange(1,16) , trs[0] , '^--' , label = r'$(\partial_x \rm{Tr}S^2) , Tr(S^2)$' , MarkerSize = 15 , color = 'green')
plt.plot(np.arange(1,16) , trs[1] , 'o--' , label = r'$(\partial_y \rm{Tr}S^2)  , Tr(S^2)$' , MarkerSize = 15, color = 'red')
...
plt.figure(figsize=(15,13))
plt.plot(np.arange(1,16) , tot_times[0] , '^--' , label = r'$(\partial_x \rm{Tr}S^2) , Tr(S^2)$' , MarkerSize = 15 , color = 'green')
plt.plot(np.arange(1,16) , tot_times[1] , 'o--' , label = r'$(\partial_y \rm{Tr}S^2)  , Tr(S^2)$' , MarkerSize = 15, color = 'red')
