...
beta 0.0 : {0,4,2,0,4,4,4,0,3,4};
beta 0.1 : {4,4,4,4,4,4,4,4,4,4};
beta 0.2 : {4,3,3,1,2,1,2,1,1,2};
beta 0.3 : {3,2,4,4,4,1,2,2,0,0};
beta 0.4 : {2,3,2,1,4,2,0,2,1,0};
beta 0.5 : {4,2,1,1,4,1,0,0,1,3};
beta 0.6 : {4,1,2,0,1,0,0,0,2,0};
beta 0.7 : {4,3,4,4,2,4,4,4,4,4};
beta 0.8 : {4,3,4,2,3,3,1,0,1,2};
beta 0.9 : {3,4,2,0,2,3,0,3,2,2};
beta 1.0 : {1,4,3,3,1,3,1,0,3,2};
*/
