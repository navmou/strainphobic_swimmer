...
beta 0.0 : {1,2,1,1,0,2,1,0,1,0};
beta 0.1 : {4,4,3,0,1,0,0,1,0,1};
beta 0.2 : {0,4,3,2,4,0,3,2,3,3};
beta 0.3 : {3,4,0,2,0,2,2,1,1,3};
beta 0.4 : {1,4,0,2,3,0,2,2,0,2};
beta 0.5 : {1,4,2,2,4,1,3,0,2,2};
beta 0.6 : {3,4,2,2,2,0,0,3,2,1};
beta 0.7 : {4,4,0,3,1,0,4,2,2,0};
beta 0.8 : {1,4,3,3,1,0,0,1,1,2};
beta 0.9 : {1,4,3,2,2,3,1,3,3,1};
beta 1.0 : {2,4,3,0,0,3,1,1,3,3};
*/
...
//opening HDF5 file
H5File file("random_grady.h5", H5F_ACC_TRUNC);
