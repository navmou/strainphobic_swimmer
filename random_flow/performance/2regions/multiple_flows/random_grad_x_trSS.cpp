...
beta 0.0 : {3,3,1,1,2,1,0,2,1,3};
beta 0.1 : {1,4,1,2,1,0,0,2,3,3};
beta 0.2 : {2,4,1,1,1,0,3,1,2,3};
beta 0.3 : {1,4,2,0,1,3,0,0,0,1};
beta 0.4 : {0,4,2,0,2,1,1,1,3,2};
beta 0.5 : {0,4,1,3,0,3,3,0,1,2};
beta 0.6 : {3,1,1,4,0,1,1,2,0,2};
beta 0.7 : {4,4,2,1,2,1,0,0,1,2};
beta 0.8 : {4,2,2,4,1,3,3,0,1,2};
beta 0.9 : {1,4,1,2,2,2,0,1,1,1};
beta 1.0 : {1,3,4,0,2,0,1,2,1,3};
*/
...
//opening HDF5 file
H5File file("random_gradx.h5", H5F_ACC_TRUNC);
